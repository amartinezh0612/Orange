 <!-- Sidebar menu-->
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user"><img class="app-sidebar__user-avatar" src="<?= media();?>/images/pequeño.png" alt="User Image">
        <div>
          <p class="app-sidebar__user-name">Andres Martinez</p>
